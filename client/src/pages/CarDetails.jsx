...
const CarDetails = () => {
  ...
  useEffect(()=>{
      setBike(dummyCarData.find(bike => bike._id === id))
  },[id])
    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {[
                  ...
                  {icon: assets.fuel_icon, text: bike.mielage},
                  {icon: assets.car_icon, text: bike.engine_type},
              ...
              {/* Featuers   */}
              <div>
                <h1 className='text-xl font-medium mb-3'>Featuers</h1>
                <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                  {
                    [ "ABS Braking System", "Electric Start","Digital Instrument Cluster", "Disc Brakes ", "LED Headlamp"].map((item)=>(
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <p className='text-center text-sm'>5% booking charge required to reserve</p>
        </form>
      </div>
