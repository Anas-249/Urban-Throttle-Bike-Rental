...
export const ownerMenuLinks = [
    ...
    { name: "Add Bike", path: "/owner/add-car", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage Bikes", path: "/owner/manage-cars", icon: carIcon, coloredIcon: carIconColored },
...
export const dummyCarData = [
    {
        ...
        "pricePerDay": 300,
        "location": "New York",
        "description": "The BMW F 800 GS is a mid-size adventure bike produced by BMW Motorrad. Built for both on-road and off-road performance.",
        "isAvaliable": true,
