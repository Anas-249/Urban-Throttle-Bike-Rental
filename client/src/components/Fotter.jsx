...
const Fotter = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500">
      ...
      <div className="flex flex-wrap justify-between items-start gap-8 pb-6 border-b border-borderColor border-b">
        ...
        <div>
          ...
          <p className="max-w-80 mt-3">
            Premium bike rental service with a wide selection of bikes for all your riding needs.
          </p>
